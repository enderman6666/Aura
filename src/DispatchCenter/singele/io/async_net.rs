use mio::{ Interest,net::{TcpStream, UdpSocket, TcpListener}};
...
use super::evenloop::{SingleCenter, NetType, NetIO};
...
pub struct  NetRead<T: 'static> {
    pub future:Rc<RefCell<SingleIO<T>>>,
